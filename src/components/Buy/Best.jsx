                ...
                <div className="product-item row">
                    <div className="product-item-link col">
                        <div className="product-item-pic">
                            <Link to="detail1">
                                <img src="/img/best product 1.jpg" width="273px" height="334px" alt="guitar" />
                            </Link>
                    ...
                    <div className="product-item-link col">
                        <div className="product-item-pic">
                            <Link to="detail2">
                                <img src="/img/best product 2.jpg" width="273px" height="334px" alt="guitar" />
                            </Link>
                        </div>
                        <Link to="detail2" >
                            <div className="product-item-text">
                    ...
                    <div className="product-item-link col">
                        <div className="product-item-pic">
                            <Link to="detail3">
                                <img src="/img/best product 3.jpg" width="273px" height="334px" alt="guitar" />
                            </Link>
                        </div>
                        <Link to="detail3" >
                            <div className="product-item-text">
                    ...
                    <div className="product-item-link col">
                        <div className="product-item-pic">
                            <Link to="detail4">
                                <img src="/img/best product 4.jpg" width="273px" height="334px" alt="guitar" />
                            </Link>
                        </div>
                        <Link to="detail4" >
                            <div className="product-item-text">
